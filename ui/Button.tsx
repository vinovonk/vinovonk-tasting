import { type CSSProperties, type ButtonHTMLAttributes, forwardRef, useState } from 'react';
...
const VARIANT_STYLES: Record<ButtonVariant, CSSProperties> = {
  ...
  ghost:       { background: 'transparent', color: 'var(--color-gray)', border: '2px solid transparent', boxShadow: 'none' },
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', style, className, onMouseEnter, onMouseLeave, onMouseDown, onMouseUp, ...props }, ref) => {
    ...
    const shadowStyle: CSSProperties = pressed
      ...
      : hovered
      ? { transform: 'translate(-2px, -2px)', boxShadow: 'var(--shadow-hover)' }
      : {};
