...
const CONTENT = {
  nl: {
    ...
    subtitle: 'Een kort overzicht van de proefmethodiek, de formulieren en de biodynamische kalender.',
    ...
    stap1Steps: [
      <><strong>Nieuwe sessie</strong> — geef de sessie een naam (bijv. "Bordeaux blind, april 2026") en kies een datum.</>,
      <><strong>Fles toevoegen</strong> — voeg per fles een notitie toe. Kies het dranktype: wijn, champagne, spirits of alcoholvrij.</>,
      <><strong>Formulier invullen</strong> — doorloop het twee-fase formulier: eerst info, dan proeven.</>,
      <><strong>Opslaan</strong> — alles blijft bewaard in je browser (localStorage). Geen account, geen server.</>,
    ],
    stap1Callout: <><strong>Tip:</strong> Je kunt een sessie ook tussentijds opslaan en later verder gaan. Alle data staat lokaal in je browser — exporteer regelmatig via Instellingen → JSON exporteren.</>,
    ...
    wijnItems: [
      <><strong>Info-fase:</strong> wijnnaam, producent, druivenras, regio, jaargang, prijs.</>,
      <><strong>Proeven-fase:</strong> visueel, neus (incl. aromapicker), gehemelte, conclusies + details voor publicatie.</>,
    ],
    ...
    bioDays: [
      ...
      { kleur: '#6b21a8', bg: '#faf5ff', border: '#d8b4fe', naam: 'Bloem\u00addag', emoji: '🌸', tekst: 'Aangenaam voor frisse, bloemige wijnen. Aromas goed.' },
    ...
    bioCallout: <><strong>Let op:</strong> De biodynamische kalender is een hulpmiddel, geen wet. Wetenschappelijk bewijs is beperkt en omstreden. Gebruik het als een extra dimensie bij je proefnotities, niet als verklaring voor kwaliteit.</>,
    ...
    archiefP2: <>Via <strong>Instellingen</strong> kun je:</>,
    archiefItems: [
      <><strong>Exporteren als JSON</strong> — handig als backup of om over te zetten naar een ander apparaat.</>,
      <><strong>Importeren vanuit JSON</strong> — laad een eerder geëxporteerd bestand terug.</>,
      <><strong>Alles wissen</strong> — verwijdert alle sessies definitief uit je browser.</>,
    ],
    archiefCallout: <><strong>Privacy:</strong> Alle data staat uitsluitend in jouw browser. Er wordt niets naar een server gestuurd. Als je de browsercache wist, gaan de notities verloren. Exporteer daarom regelmatig.</>,
  },
  en: {
    back: '← Back',
    ...
    subtitle: 'A brief overview of the tasting methodology, forms and the biodynamic calendar.',

    stap1Label: 'Step 1',
    stap1Title: 'Starting a tasting session',
    stap1P: <>
      Every tasting begins with a <strong>session</strong> — a moment where you assess one or more bottles side by side.
      Think of a wine class, a blind tasting with friends, or an evening where you simply log what you drink.
    </>,
    stap1Steps: [
      <><strong>New session</strong> — give the session a name (e.g. "Bordeaux blind, April 2026") and choose a date.</>,
      <><strong>Add bottle</strong> — add a note per bottle. Choose the drink type: wine, champagne, spirits or non-alcoholic.</>,
      <><strong>Fill in the form</strong> — work through the two-phase form: first info, then tasting.</>,
      <><strong>Save</strong> — everything is stored in your browser (localStorage). No account, no server.</>,
    ],
    stap1Callout: <><strong>Tip:</strong> You can save a session mid-way and continue later. All data is stored locally in your browser — export regularly via Settings → Export JSON.</>,
    ...
    wijnP2: <>
      The form runs across four tabs: <em>Appearance → Nose → Palate → Conclusions</em>.
      It closes with a quality assessment on the BLIC scale (Balance, Length, Intensity, Complexity)
      and a drinking recommendation.
    </>,
    wijnItems: [
      <><strong>Info phase:</strong> wine name, producer, grape variety, region, vintage, price.</>,
      <><strong>Tasting phase:</strong> visual, nose (incl. aroma picker), palate, conclusions + details for publication.</>,
    ],
    ...
    spiritsP: <>
      The spirits form has fields for spirit type (whisky, cognac, gin, rum etc.),
      age, distillery and a custom aroma picker with distillate aromas.
    ...
    alcoholvrijP: <>
      ...
      Unique field: <em>comparison with alcoholic variant</em> — what is missing, what is better?
    </>,

    generiekTitle: 'Generic form',
    generiekP: <>
      For beer, sake, cider or anything that does not fit the other categories.
      Simpler layout with the core parameters: appearance, nose, palate, quality.
    </>,
    ...
    aromaP1: <>
      ...
      Aromas are grouped in categories (primary fruit, secondary fermentation, tertiary oxidative/maturation).
      You can also type and add custom aromas.
    </>,
    aromaP2: <>
      On the palate tab, nose aromas are pre-selected — you can confirm or adjust them.
      Aromas you noted on the nose but not on the palate are automatically dropped.
    </>,

    bioLabel: 'Feature',
    bioTitle: 'The biodynamic calendar',
    bioP: <>
      The biodynamic wine calendar is based on the agricultural calendar of <strong>Maria Thun</strong>
      (later applied in wine by, among others, Cees van Casteren MW). The idea: the position of the moon
      along the zodiac influences how wine tastes.
    </>,
    bioDagTypesTitle: 'The four day types',
    bioDays: [
      { kleur: '#166534', bg: '#f0fdf4', border: '#86efac', naam: 'Fruit day', emoji: '🍇', tekst: 'Optimal for tasting. Wine is open, aromatic and expressive.' },
      { kleur: '#6b21a8', bg: '#faf5ff', border: '#d8b4fe', naam: 'Flower day', emoji: '🌸', tekst: 'Pleasant for fresh, floral wines. Aromas are clear.' },
      { kleur: '#115e59', bg: '#f0fdfa', border: '#5eead4', naam: 'Leaf day', emoji: '🌿', tekst: 'Wine may taste green, sharp or flat. Less ideal.' },
      { kleur: '#92400e', bg: '#fffbeb', border: '#fcd34d', naam: 'Root day', emoji: '🌱', tekst: 'Hardest tasting day. Wine often closed and tannic.' },
    ],
    bioBadgeP: <>
      The badge on the dashboard shows today's day type. Click it for the full calendar view
      with a 14-day overview, moon phase indicator and explanation per day type.
    </>,
    bioCallout: <><strong>Note:</strong> The biodynamic calendar is a tool, not a law. Scientific evidence is limited and contested. Use it as an extra dimension in your tasting notes, not as an explanation for quality.</>,

    archiefLabel: 'Feature',
    archiefTitle: 'Archive & export',
    archiefP1: <>
      Via <strong>Archive</strong> you can see all your tasting notes in one place, searchable by name and filterable
      by drink type and score. Click a note to edit it.
    </>,
    archiefP2: <>Via <strong>Settings</strong> you can:</>,
    archiefItems: [
      <><strong>Export as JSON</strong> — useful as a backup or to transfer to another device.</>,
      <><strong>Import from JSON</strong> — reload a previously exported file.</>,
      <><strong>Delete everything</strong> — permanently removes all sessions from your browser.</>,
    ],
    archiefCallout: <><strong>Privacy:</strong> All data is stored exclusively in your browser. Nothing is sent to a server. If you clear the browser cache, notes will be lost. Export regularly.</>,
  },
};
    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem var(--gap)' }}>
      ...
      <section>
        ...
        <ol style={{ paddingLeft: '1.25rem', margin: 0 }}>
          {C.stap1Steps.map((s, i) => <li key={i} style={liStyle}>{s}</li>)}
        </ol>
      ...
      <section style={sectionStyle}>
        ...
        <ul style={{ paddingLeft: '1.25rem', margin: '0 0 0.75rem' }}>
          {C.wijnItems.map((s, i) => <li key={i} style={liStyle}>{s}</li>)}
        </ul>
      ...
      <section style={sectionStyle}>
        ...
        <ul style={{ paddingLeft: '1.25rem', margin: '0 0 0.75rem' }}>
          {C.archiefItems.map((s, i) => <li key={i} style={liStyle}>{s}</li>)}
        </ul>
