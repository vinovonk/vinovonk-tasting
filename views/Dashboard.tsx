...
const DAGTYPE_KLEUR: Record<string, { bg: string; border: string; color: string }> = {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem var(--gap)' }}>
      ...
      <div style={{ marginBottom: '2rem', borderBottom: '4px solid var(--color-border)', paddingBottom: '1.5rem' }}>
        ...
        <h1 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', margin: '0 0 1rem' }}>
      ...
      {sessions.length === 0 ? (
        <div style={{
          ...
          <button
            ...
            style={{ background: 'none', border: 'none', cursor: 'pointer', fontFamily: 'var(--font-body)', fontSize: '0.8rem', fontWeight: 700, color: 'var(--color-primary)', textDecoration: 'underline', padding: 0, marginTop: '0.5rem' }}
          >
          ...
          {sessions.map((s) => (
            ...
            >
              ...
              <div style={{
                ...
                {s.aantalFlessen} {lang === 'en'
                  ? s.aantalFlessen === 1 ? 'bottle' : 'bottles'
                  : s.aantalFlessen === 1 ? 'fles' : 'flessen'}
              </div>
            </button>
          ))}
        </div>
