...
const CONTENT = {
	nl: {
		...
		subtitle:
			"Deze app is gebouwd op gevestigde proefmethodieken en wetenschappelijke berekeningen. Hieronder vind je de bronnen en inspiratie.",
		...
		thunDesc:
			"Basis voor de dagtype-berekening (fruit/bloem/blad/wortel). Maria Thun (1922–2012) deed jarenlang veldproeven naar de invloed van de maanpositie op gewassen. Haar methode wordt inmiddels door wijnmakers en sommeliers wereldwijd gebruikt.",
		thunOrg:
			'Jaarlijkse publicatie: "Werken met de Kosmische Ritmen" / "Aussaattage" — mariathun.com',

		meeusName: "Jean Meeus — Astronomical Algorithms",
		meeusDesc:
			"Basis voor de siderische maanpositie-berekening in de biodynamische kalender. Het algoritme in biodynamisch.ts volgt Meeus' vereenvoudigde methode (hoofdstuk 47) met ayanamsa-correctie voor het tropisch↔siderisch verschil.",
		meeusOrg:
			'Jean Meeus, "Astronomical Algorithms", Willmann-Bell, 1991/1998. ISBN 978-0943396613.',

		cvcName: "Cees van Casteren MW",
		cvdDesc:
			"Master of Wine en BBC wine presenter. Van Casteren populariseerde het gebruik van de biodynamische kalender bij serieuze wijnproeverijen in de Nederlandse en internationale wijnwereld. Zijn aanbeveling om geen wijnen te beoordelen op worteldagen is in de app expliciet verwerkt.",
		...
		libraries: [
			...
			{ name: "Sonner", license: "MIT", desc: "Toast-notificaties" },
			{
				name: "Radix UI",
				license: "MIT",
				desc: "Toegankelijke UI-primitieven",
			},
		...
		disclaimerText:
			"Deze app is een onafhankelijk, niet-commercieel project. Alle handelsnamen en methodes zijn eigendom van hun respectievelijke rechthebbenden. Geen van de genoemde organisaties heeft deze app onderschreven of goedgekeurd.",
	},
	en: {
		back: "← Back",
		...
		title: "Attributions",
		subtitle:
			"This app is built on established tasting methodologies and scientific calculations. Below you will find the sources and inspiration.",
		...
		thunDesc:
			"Foundation for the day-type calculation (fruit/flower/leaf/root). Maria Thun (1922–2012) conducted years of field trials on the influence of the moon's position on crops. Her method is now used by winemakers and sommeliers worldwide.",
		thunOrg:
			'Annual publication: "Aussaattage" / "Working with the Stars" — mariathun.com',

		meeusName: "Jean Meeus — Astronomical Algorithms",
		meeusDesc:
			"Foundation for the sidereal moon position calculation in the biodynamic calendar. The algorithm in biodynamisch.ts follows Meeus' simplified method (chapter 47) with ayanamsa correction for the tropical↔sidereal difference.",
		meeusOrg:
			'Jean Meeus, "Astronomical Algorithms", Willmann-Bell, 1991/1998. ISBN 978-0943396613.',

		cvcName: "Cees van Casteren MW",
		cvdDesc:
			"Master of Wine and BBC wine presenter. Van Casteren has popularised the use of the biodynamic calendar in serious wine tasting in the Dutch and international wine world. His recommendation to avoid assessing wines on root days is explicitly incorporated in the app.",
		...
		disclaimerLabel: "Disclaimer",
		disclaimerText:
			"This app is an independent, non-commercial project. All trade names and methods are the property of their respective owners. None of the organisations mentioned have endorsed or approved this app.",
	},
};
