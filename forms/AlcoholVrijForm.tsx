...
function getSubTypeOpties(lang: Lang) {
	return lang === "en"
		? [
				{ waarde: "proxy-wijn", label: "Proxy wine" },
				{ waarde: "spirit-0", label: "Spirit 0%" },
				{ waarde: "thee", label: "Tea" },
			...
			<div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
					...
					>
						...
						>
							<Input
								label={L.naam}
								placeholder={
									data.subType === "proxy-wijn"
										? lang === "en"
											? "E.g. Oddbird Sparkling Rosé"
											: "Bijv. Oddbird Sparkling Rosé"
										: data.subType === "spirit-0"
											? lang === "en"
												? "E.g. Seedlip Garden 108"
												: "Bijv. Seedlip Garden 108"
											: data.subType === "thee"
												? lang === "en"
													? "E.g. Gyokuro First Flush"
													: "Bijv. Gyokuro First Flush"
												: lang === "en"
													? "Name..."
													: "Naam..."
								}
							...
							/>
							<Input
								label={lang === "en" ? "Brand / Producer" : "Merk / Producent"}
								placeholder={lang === "en" ? "Producer..." : "Producent..."}
								value={data.merk || ""}
						...
						>
							...
							<Input
								label={L.spiritLand}
								placeholder={lang === "en" ? "Country..." : "Land..."}
								value={data.land || ""}
						...
						{data.subType === "anders" && (
							<Input
								label={L.specificeerType}
								placeholder={L.specificeerType_placeholder}
								value={data.customSubType || ""}
								onChange={(e) =>
									setData({ ...data, customSubType: e.target.value })
								}
							/>
						)}
					</CardContent>
						...
						<Card>
							...
							>
								...
								<Input
									...
									placeholder={
										lang === "en"
											? "E.g. pale gold, ruby, clear..."
											: "Bijv. lichtgoud, robijnrood, helder..."
									}
									value={data.uiterlijk.kleur || ""}
									onChange={(e) =>
										setData({
											...data,
											uiterlijk: { ...data.uiterlijk, kleur: e.target.value },
										})
									}
								/>
								<Input
									...
									onChange={(e) =>
										setData({
											...data,
											uiterlijk: { ...data.uiterlijk, overig: e.target.value },
										})
									}
								/>
							</CardContent>
						...
						<Card>
							...
							>
								...
								<div>
													...
													<button
														...
														onClick={() =>
															setData({
																...
																neus: {
																	...data.neus,
																	aromas: toggle(data.neus.aromas, a),
																},
															})
														}
														style={{
									...
									>
										{aromas.map((a) => (
											<button
												...
												style={pillStyle(data.neus.aromas.includes(a))}
											>
												{a}
											</button>
										))}
									...
									<div
										style={{ display: "flex", gap: "4px", marginTop: "0.5rem" }}
									>
										<input
											...
											onKeyDown={(e) => {
												if (e.key === "Enter" && customAroma.trim()) {
													...
													setData({
														...
														neus: {
															...data.neus,
															aromas: [...data.neus.aromas, customAroma.trim()],
														},
													});
													setCustomAroma("");
												}
								...
								<ButtonGroup
									...
									onChange={(v) =>
										setData({
											...
											gehemelte: {
												...data.gehemelte,
												bitterheid: v as typeof data.gehemelte.bitterheid,
											},
										})
									}
								/>
								<ButtonGroup
									...
									onChange={(v) =>
										setData({
											...
											gehemelte: {
												...data.gehemelte,
												koolzuur: v as typeof data.gehemelte.koolzuur,
											},
										})
									}
								/>
											...
											<button
												...
												onClick={() =>
													setData({
														...
														gehemelte: {
															...data.gehemelte,
															smaken: toggle(data.gehemelte.smaken, a),
														},
													})
												}
												style={pillStyle(data.gehemelte.smaken.includes(a))}
											>
												{a}
											</button>
										))}
								...
								<ButtonGroup
									...
									onChange={(v) =>
										setData({
											...
											gehemelte: {
												...data.gehemelte,
												afdronk: v as typeof data.gehemelte.afdronk,
											},
										})
									}
								/>
					...
					<TabsContent value="conclusions">
						<Card>
							...
							>
								...
								/>
								<Textarea
									label={L.vergelijking}
									placeholder={L.vergelijking_placeholder}
									...
									onChange={(e) =>
										setData({
											...
											conclusie: {
												...data.conclusie,
												vergelijkingMetAlcohol: e.target.value,
											},
										})
									}
									rows={3}
				...
				<div style={{ display: "flex", gap: "0.5rem" }}>
					...
					{tab !== "conclusions" ? (
						...
						<Button
							onClick={() => onSave(data, notitie, score)}
							style={{ flex: 1 }}
						>
							{L.opslaan}
						</Button>
