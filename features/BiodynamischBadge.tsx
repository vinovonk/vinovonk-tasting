...
export function BiodynamischBadge({ datum, variant = 'compact' }: BiodynamischBadgeProps) {
  ...
  return (
    <div style={{
      ...
      <div>
        ...
        <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.82rem', color: 'var(--color-gray)', lineHeight: 1.5 }}>
          {info.beschrijving}
        </div>
        <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.72rem', fontWeight: 600, marginTop: '0.4rem', color: 'var(--color-on-surface)' }}>
          {info.aanbeveling}
        </div>
      </div>
    </div>
