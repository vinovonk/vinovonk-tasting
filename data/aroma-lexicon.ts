...
// === Alle aroma's plat ===
export function getAllAromas(
	type: "primair" | "secundair" | "tertiair",
): string[] {
	const bron =
		type === "primair"
			? primaireAromas
	...
	return bron.flatMap((cat) => cat.subcategorieen.flatMap((sub) => sub.aromas));
}

// Zoek aroma's
export function zoekAromas(
	zoekterm: string,
	type?: "primair" | "secundair" | "tertiair",
): string[] {
