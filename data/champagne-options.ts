...
export const champagneDruivenRassen: string[] = [
  'Chardonnay', 'Pinot Noir', 'Meunier', 'Chardonnay Rosé',
...
const CHAMPAGNE_PRODUCENTEN = [
  ...
  'De Castellane','Duval-Leroy','Drappier','AR Lenoble','Palmer & Co',
  ...
  'Benoît Lahaye','Vincent Charlot','Marguet','Laherte Frères',
  'Gatinois','Gaston Chiquet','André Clouet','Tarlant',
];
...
const CHAMPAGNE_VILLAGES = [
  ...
  'Côte de Sézanne','Hautvillers','Tauxières','Mutigny','Mareuil-sur-Aÿ','Dizy',
  'Cumières','Damery','Fleury-la-Rivière','Vinay','Moussy',
  'Vertus','Villers-Marmery','Trépail','Rilly-la-Montagne',
...
export const champagneAromaCategorieen = [
  { categorie: 'Floral', aromas: ['White flowers','Acacia','Rose','Honeysuckle','Jasmine','Elder flower'] },
  { categorie: 'Citrus', aromas: ['Lemon','Lime','Grapefruit','Orange zest','Yuzu','Lemon curd'] },
  { categorie: 'Green / White fruit', aromas: ['Green apple','Golden apple','Pear','Quince','White peach','Nectarine'] },
  { categorie: 'Stone fruit', aromas: ['Peach','Apricot','Plum','Mirabelle'] },
  { categorie: 'Tropical fruit', aromas: ['Pineapple','Mango','Passion fruit','Lychee'] },
  { categorie: 'Red fruit', aromas: ['Red cherry','Strawberry','Raspberry','Redcurrant','Pomegranate'] },
  { categorie: 'Dried / Candied fruit', aromas: ['Dried apricot','Candied lemon','Fig','Raisins','Prune','Marmalade'] },
  { categorie: 'Autolytic', aromas: ['Brioche','Biscuit','Toast','Pastry','Cream','Butter','Almond','Hazelnut','Walnut','Yeast','Dough'] },
  { categorie: 'Mineral', aromas: ['Chalk','Flint','Wet stone','Oyster shell','Iodine','Smoke'] },
  { categorie: 'Spice', aromas: ['Ginger','White pepper','Cinnamon','Anise','Liquorice'] },
  { categorie: 'Oxidative / Aged', aromas: ['Honey','Beeswax','Dried flowers','Toffee','Caramel','Dried nuts','Coffee','Chocolate','Tobacco','Mushroom'] },
